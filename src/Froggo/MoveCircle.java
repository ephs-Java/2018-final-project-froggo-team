...
public class MoveCircle {
	...
	public class TestPane extends JPanel {
		...
		public TestPane() {
			...
			am.put("pressed.down", new MoveAction(0, false));
			am.put("pressed.up", new MoveAction(0, false));
			am.put("released.down", new MoveAction(-2, true));
			am.put("released.up", new MoveAction(2, true));
		...
		protected void paintComponent(Graphics g) {
			...
			g2d.drawOval(xPos - 50, 0, radius, radius);
			g2d.drawOval(xPos - 100, 0, radius, radius);
			g2d.drawOval(xPos - 150, 0, radius, radius);
			g2d.dispose();
		}
